...
const Fragrance = () => {
  ...
  const { data: fragranceProducts = [], isLoading } = useCollectionProducts('fragrance', 250);

  const products = useMemo(() => {
    // First, filter by search query
    let filtered = [...fragranceProducts];
  ...
  }, [fragranceProducts, sortOption, searchQuery, priceRange, availability]);
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Fragrance Collection - Lumina</title>
        <meta name="description" content="Explore Lumina's fragrance oil collection. Intentional scent, balanced and personal without being overpowering." />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Fragrance Collection - Lumina" />
        <meta property="og:description" content="Explore Lumina's fragrance oil collection. Intentional scent, balanced and personal." />
        <meta property="og:url" content="https://luminaco.skin/fragrance/" />
        <meta property="og:image" content="https://luminaco.skin/images/og%20image.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Fragrance Collection - Lumina" />
        <meta name="twitter:description" content="Explore Lumina's fragrance oil collection." />
